...
cfg_var_dec1 = ["null"]
cfg_array_dec = ["data_type", "arr", "[", "index", "]", "array_index2", "array_index3", "id"]
cfg_array_dec = ["data_type", "arr", "[", "index", "]", "array_index2", "array_index3", "id", "=", "{", "array_value", "}"]
...
cfg_struct_init = ["site", "id", "array_elem", "=", "{", "value", "more_struct", "}"]
...
cfg_if_stmt = ["if", "(", "condition", ")", "{", "statements", "}", "if_stmt1", "if_stmt2"]
cfg_condition = ["map_literal"]
cfg_condition = ["rela_expr"]
cfg_condition = ["log_expr"]
cfg_if_stmt1 = ["elif", "(", "condition", "{", "statements", "}", "if_stmt1", "if_stmt2"]
cfg_if_stmt1 = ["null"]
...
cfg_more_votes = ["vote", "case_literal", ":", "statements", "kill", ";", "more_votes"]
cfg_more_votes = ["null"]
cfg_break = ["kill", ";"]
cfg_break = ["null"]
...
cfg_for_stmt = ["for", "(", "for_init", ";", "loop_cond", ";", "una_expr", ")", "{", "statements", "break_con", "}"]
...
cfg_break_con = ["kill"]
cfg_break_con = ["null"]
cfg_while_stmt = ["while", "(", "loop_cond", ")", "{", "statements", "break_con", "}"]
cfg_dowhile_stmt = ["do", "{", "statements", "break_con", "}", "while", "(", "loop_cond", ")", ";"]
cfg_function_def = ["plant", "func_type", "id", "(", "param", ")", "{", "local_dec", "statements", "}"]
